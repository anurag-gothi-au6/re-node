    ...
    if (message.sent === false) {
      return (
        <li className="replies" key={message.uuid}>
          <img
            src={`https://res.cloudinary.com/renode/image/upload/public/images/profile-picture/100x100/${profilePicture}`}
            alt=""
          />
          <p
            style={{
          ...
          <Popup
            ...
            trigger={
              <img
                ...
                src={`https://res.cloudinary.com/renode/image/upload/public/images/chat-images/${message.photo}`}
                alt=""
              />
            }
          />
    ...
    if (message.sent === false) {
      return (
        <li className="sent" key={message.uuid}>
          <img
            src={`https://res.cloudinary.com/renode/image/upload/public/images/profile-picture/100x100/${currentRoom.user.profilePicture}`}
            alt=""
          />
          <p
            style={{
