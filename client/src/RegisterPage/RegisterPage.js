...
import Background from '../LoginPage/loginBack.jpg'
class RegisterPage extends React.Component {
  ...
  componentDidMount = () => {
    document.title = "Register | re-node";
  };
  ...
  render() {
    ...
    return (
      <>
      <img src={Background} alt='background' style={{position:'absolute',height:'100%',width:'100%'}}></img>
