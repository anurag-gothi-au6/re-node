...
class ProfilePage extends Component {
  componentDidMount = () => {
    document.title = "Profile | re-node";
  };
        ...
        <Modal
          ...
          trigger={
            <div className="gallery-item">
              <img
                src={`https://res.cloudinary.com/renode/image/upload/public/images/post-images/thumbnail/${post.photo}`}
              ...
              <div className="container">
                ...
                <div className="profile">
                  <div className="profile-image">
                    <img
                      src={`https://res.cloudinary.com/renode/image/upload/public/images/profile-picture/100x100/${user.data.profilePicture}`}
                      alt=""
                    />
                  </div>
