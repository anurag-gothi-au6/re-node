...
import logo from '../styles/Black and Orange Simple Internet Logo.png'
  ...
  return (
    <span>
      <Image
        size="mini"
        avatar
        src={"https://res.cloudinary.com/renode/image/upload/public/images/profile-picture/100x100/" + image}
      />{" "}
      {name}
    </span>
  );
      ...
      return (
        <div className="main-navbar">
          <div className="nav-item logo">
            <Link to={"/"}><img src={logo} style={{height:'4.8rem',width:'70%'}} alt='social network'></img></Link>
          </div>
