      ...
      <div className="post" style={{ marginBottom: isFeedMarginBottom }}>
        <div className="post-header">
          <div className="post-label">
            <div className="label-image">
              <img
                src={`https://res.cloudinary.com/renode/image/upload/public/images/profile-picture/100x100/${post.author[0].profilePicture}`}
                alt=""
              />
            </div>
        ...
        <div className="post-image">
          {this.state.loadedImg ? null : (
            <Segment loading>
              <Image src={`https://res.cloudinary.com/renode/image/upload/public/images/post-images/thumbnail/${post.photo}`} />
            </Segment>
          )}
          <img
            ...
            src={`https://res.cloudinary.com/renode/image/upload/public/images/post-images/${post.photo}`}
            alt=""
          />
          {ribbon}
          {renderDivs}
